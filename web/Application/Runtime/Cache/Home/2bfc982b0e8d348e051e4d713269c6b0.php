	...
	<div class="panel panel-success">
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					<?php if(is_array($res["list"])): foreach($res["list"] as $key=>$v): ?><tr data-id="<?php echo ($v['Id']); ?>" data-tb="<?php echo ($v['TableName']); ?>">
							<td >
							...
							<td  class="text-center " data-count><img src="/Public/img/min-load.gif" /></td>
